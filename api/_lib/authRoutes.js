/* MIRROR of server/routes/auth.js — keep in sync.

   Logic is unchanged. Only the User import path differs, because this copy
   lives alongside User.js rather than in server/models/.

   process.env.JWT_SECRET is read inside the handlers (not at module scope),
   which is already correct for cold starts. */
